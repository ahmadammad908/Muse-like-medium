              ...
              <div className="p-8 space-y-4">
                {(isSignUp ? signUpOptions : signInOptions).map((option) => (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="flex items-center space-x-4 p-4 border-2 border-slate-200 rounded-xl hover:border-slate-300 hover:bg-white transition-all duration-200 w-full text-left group shadow-sm"
                  >
